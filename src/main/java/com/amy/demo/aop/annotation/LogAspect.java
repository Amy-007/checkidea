...
import com.amy.demo.utils.AddressUtil;
import com.amy.demo.utils.HttpContextUtils;
import com.amy.demo.utils.IPUtil;
...
public class LogAspect {
    ...
    @Autowired
    private LogMapper operLogMapper;

    @Pointcut("@annotation(com.amy.demo.aop.annotation.LogAnnotation)")
